...
public class QuestionActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void getQuestionsList() {
        ...
        questionList.add(new Question(" What is the sum of 5+3 = ", "8 ", "3", "1", 1));
        questionList.add(new Question("What is the answer of the given question 2-1 =", "0", "2", "1", 3));
        questionList.add(new Question("Answer of 2+2+1 = ", "18", "5", "0", 2));
        setQuestion();
