...
public class C5QuestionActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void getQuestionsList() {
        ...
        questionList.add(new Question("The capital of Pakistan is ", "Islamabad", "Faislabad", "Karachi", 1));
        questionList.add(new Question("Which of teh given country is a landlock country :", "Sirlanka", "Afghanistan", "Nepal", 2));
        questionList.add(new Question("Total area of Pakistan is : ", "68965235", "8916301", "796096", 3));
        setQuestion();
    ...
    private void changeQuestion() {
        ...
        if (questNum < questionList.size() - 1) {
            ...
            //Score Activity
            Intent intent = new Intent(C5QuestionActivity.this, Score.class);
