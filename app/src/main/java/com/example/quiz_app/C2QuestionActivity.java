...
public class C2QuestionActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void getQuestionsList() {
        ...
        questionList.add(new Question("Select capital letter", "a", "c", "A", 3));
        questionList.add(new Question("Select even number form the given options", "8", "9", "1", 1));
        questionList.add(new Question("How manydays are there in January:", "31", "28", "30", 1));
        setQuestion();
