...
public class C3QuestionActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void getQuestionsList() {
        ...
        questionList.add(new Question(" What is the sum of 2+2 = ", "8 ", "4", "1", 2));
        questionList.add(new Question("What is the answer of the given question 2*9 =", "18", "2", "10", 1));
        questionList.add(new Question("Answer of 5*5 = ", "25", "50", "0", 3));
        setQuestion();
