...
public class C6QuestionActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void getQuestionsList() {
        ...
        questionList.add(new Question(" Urdu was decleared as national language in the year: ", "1954", "1676", "1948", 1));
        questionList.add(new Question("Maximum number of languages are spoken in this provience: ", "Sindh", "Balochiatan", "Punjab", 2));
        questionList.add(new Question("Urdu is a word of this language", "Sindhi language;", "Turkish language;", "Balochi langauge", 2));
        setQuestion();
    ...
    private void changeQuestion() {
        ...
        if (questNum < questionList.size() - 1) {
            ...
            //Score Activity
            Intent intent = new Intent(C6QuestionActivity.this, Score.class);
